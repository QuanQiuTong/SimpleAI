 ...
 * @brief   Implement a "Button" class template (实现一个按钮类模板).
 * @version 0.1
 * @date    2022-12-03
 *
...
public:
    textbox(int l, int t, int r, int b, std::string text, size_t maxlen) : left(l), top(t), right(r), bottom(b), text(text), maxlen(maxlen) {}
    ~textbox() = default;
